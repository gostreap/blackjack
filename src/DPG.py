...
class DPG:
    def __init__(self, epsilon=0.1, gamma=0.5, alpha=0.1) -> None:
        self.alpha = alpha
        self.gamma = gamma
    ...
    def train(self, n_episode):
        ...
        for i in range(n_episode):
            ...
            while not done:
                ...
                maxvalue = max(self.Q[self.get_observation_int(next_observation)][0], self.Q[self.get_observation_int(next_observation)][1])
